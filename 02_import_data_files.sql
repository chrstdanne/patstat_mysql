...
LOAD DATA LOCAL INFILE '<SET PATH TO DATA FOLDER>/tls206_part02.csv'  
INTO TABLE tls206_person
FIELDS TERMINATED BY ','  
ENCLOSED BY '"' LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE '<SET PATH TO DATA FOLDER>/tls209_part02.csv'  
INTO TABLE tls209_appln_ipc
FIELDS TERMINATED BY ','  
ENCLOSED BY '"' LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;
 
LOAD DATA LOCAL INFILE '<SET PATH TO DATA FOLDER>/tls209_part03.csv'  
INTO TABLE tls209_appln_ipc
FIELDS TERMINATED BY ','  
ENCLOSED BY '"' LINES TERMINATED BY '\r\n' 
IGNORE 1 LINES;
...
INTO TABLE tls214_npl_publn
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' LINES TERMINATED BY '\r\n'
IGNORE 1 LINES ;

LOAD DATA LOCAL INFILE '<SET PATH TO DATA FOLDER>/tls214_part02.csv'  
INTO TABLE tls214_npl_publn
FIELDS TERMINATED BY ',' 
ENCLOSED BY '"' LINES TERMINATED BY '\r\n'
IGNORE 1 LINES ;
...
-- LOAD DATA LOCAL INFILE '<SET PATH TO DATA FOLDER>/tls231_part13.csv'  
-- INTO TABLE tls231_inpadoc_legal_event
-- FIELDS TERMINATED BY ','  
-- ENCLOSED BY '"' LINES TERMINATED BY '\r\n' 
-- IGNORE 1 LINES;
